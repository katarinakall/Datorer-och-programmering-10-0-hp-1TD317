...
bool Transaktion::laesEnTrans(istream &is)
{
    ...
    for (int i = ant_kompisar; i < MAX_PERSONER; i++) //Rensar bort namn som fanns i förra transaktionen men ej denna.
    {
        kompisar[i] = "";
    }
...
Uppgiften gick ut på att  skriva ett program som läser in ett antal transaktioner och sedan räknar ut hur mycket
var och en har betalat, om de är skyldiga pengar eller om de ska få tillbaka pengar.

Jag tycker att det var särksillt svårt att jobba med en så pass stor uppgift. Jag försökte föja råden med att
implementera lite i taget och testa efter hand.
